...
/**
 * Contains methods providing functionality of the <code>/user/login</code> API route. It
...
public class LoginService {
     ...
     * 
     * @param request the login request, which specifies the user to login and his/her
     * password
