/* TODO: Go over the spec again to make sure nothing is missing. And test these, of course! */
...
CREATE TABLE user (
    ...
    CHECK (gender IN ('f', 'm')),
    FOREIGN KEY (person_id) REFERENCES person(id)   /* or should I do it the other way around... */
);
